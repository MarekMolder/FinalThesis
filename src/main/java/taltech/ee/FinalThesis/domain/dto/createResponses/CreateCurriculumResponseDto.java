package taltech.ee.FinalThesis.domain.dto.createResponses;
...
@AllArgsConstructor
@NoArgsConstructor
public class CreateCurriculumResponseDto {
    private UUID id;
    ...
    private UUID userId;
    private List<CreateCurriculumVersionResponseDto> curriculumVersions = new ArrayList<>();
