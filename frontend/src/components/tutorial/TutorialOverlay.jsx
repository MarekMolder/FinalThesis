  ...
  return (
    <>
      ...
      <div
        ...
        style={popupStyle()}
      >
        <div className="rounded-2xl border border-white/60 dark:border-slate-700 bg-white/95 dark:bg-slate-800/95 p-5 shadow-2xl backdrop-blur-xl">
          ...
          <h3 className="text-base font-bold text-slate-900 dark:text-slate-100">{stepConfig.title}</h3>
          ...
          <div className="mt-4 flex items-center justify-between gap-3">
            {!isFirst ? (
              <button
                onClick={onPrev}
                className="rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700"
              >
                Eelmine
              </button>
            ) : (
