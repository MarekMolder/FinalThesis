  ...
  return (
    <div className="relative min-h-svh w-full overflow-hidden bg-slate-50">
      ...
      <div className="relative z-10 mx-auto grid min-h-svh w-full max-w-6xl place-items-center px-5 py-12">
        <div
          className={[
            'grid w-full overflow-hidden rounded-2xl bg-white/45 shadow-[0_30px_90px_rgba(0,0,0,0.18)] ring-1 ring-slate-200/70 backdrop-blur-2xl',
        ...
        >
          ...
          {/* Brand pane (sinine rectangle) – laius: BRAND_PANE_WIDTH */}
          <div className={['relative hidden md:block', isLeft ? 'order-1' : 'order-2'].join(' ')} aria-hidden="true">
            ...
            <div className="relative flex h-full flex-col pl-2 pt-2 pr-6 pb-8 text-white">
              {/* Logo väga vasakus nurgas; pealkiri samal joonelt või kohe alt */}
              ...
              {/* Allolev tekst – mugav reavahe ja paigutus */}
              <div className="mt-8 max-w-[260px] text-[15px] leading-[1.55] text-white/95 drop-shadow-[0_6px_16px_rgba(0,0,0,0.22)]">
