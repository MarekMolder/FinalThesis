...
export default function ScheduleStep({ versionId, curriculumId, items, onFinish }) {
  ...
  return (
    <div className="p-6">
      <div className="mb-4 flex items-start justify-between">
        <div>
          <h2 className="text-xl font-bold tracking-tight text-slate-900">Ajakava</h2>
          <p className="mt-1 text-sm text-slate-500">Planeeri millal iga element õpetatakse.</p>
        </div>
        <button
          onClick={finish}
          disabled={finishing}
      ...
      <CurriculumCalendar curriculumVersionId={versionId} />
    </div>
  );
}
